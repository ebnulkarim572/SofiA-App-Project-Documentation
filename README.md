# Robust Gas and Smoke Sensing Device With SofiA (Social Fire Alarm)
...
To achieve this, the use social networks scraping, detecting fire or dangerous situations in real time. In addition to that, we have created Robust Gas and Smoke Sensing Device which collaborated with mobile App SofiA where users can report alerts directly, see valuable information, etc.  
...
![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/diagrams/SofiaSummary.jpg)
...
![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/images/APP%20Mockup.jpg)
...
- Project & Documentation: https://github.com/ebnulkarim572/SofiA-App-Project-Documentation
- APP, Sofia Server & API: https://github.com/ebnulkarim572/SofiA-APP-Sofia-Server-API
- Hardware-Robust Gas and Smoke Sensing Device: https://github.com/ebnulkarim572/Robust_Gas_and_Smoke_Sensing_Device
- Augmented Reality POC: https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/tree/master/AugmentedReality
...
![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/diagrams/SoFiaModel.jpg)

The complete description of the model can be found in the following [document](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/docs/SofiaModel/SoFiA_model.pdf).

### App UX flow
We show a flowchart of the APP:
 
![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/diagrams/UserFlowchart.png)
...
![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/diagrams/Gamification.jpg)

This is the ranking of users competing globally in three different categories

![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/images/GamificationRanking.jpg)
 
More information in the following [document](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/docs/SOFIA%20Social%20Network.pdf).
...
![N|Solid](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/diagrams/EscapeRoutes.jpg)

For more information see the following [document](https://github.com/ebnulkarim572/SofiA-App-Project-Documentation/blob/master/docs/Escape%20routes.pdf).
